...
public class MultiManiaWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MultiManiaWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MultiplyTheCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MultiplyTheCashWLAIW/InitOutcome.xml").getDocumentElement();
